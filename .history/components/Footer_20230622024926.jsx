...
// }
  ...
  return(
     <footer className='bg-dSec text-white txt-sha text-md  border-t-2 p-2 md:flex items-center justify-around text-center font-disp'>
         ...
         <h1>Reach Me On <a href='https://twitter.com/Subham_Coder' rel="noopener noreferrer" target={'_blank'}>< FontAwesomeIcon icon={faTwitter} className='text-blue-500  text-xl mx-1'/></a> <a href='https://github.com/RoshanRv' rel="noopener noreferrer" target={'_blank'}>< FontAwesomeIcon icon={faGithub} className='text-xl  mx-1 bg-white text-black rounded-full '/></a> <a href='https://www.linkedin.com/in/roshan-kumar-5a5020220/' rel="noopener noreferrer" target={'_blank'}> < FontAwesomeIcon icon={faLinkedin} className='text-xl  mx-1 text-blue-700 bg-white '/></a></h1>
